...
Pod::Spec.new do |s|
  s.name             = 'Delugion'
  s.version          = '0.1.0'
  s.summary          = 'A short description of Delugion.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/yotamo/Delugion'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'yotamo' => 'ohayon.yotam@gmail.com' }
  s.source           = { :git => 'https://github.com/yotamo/Delugion.git', :tag => s.version.to_s }
